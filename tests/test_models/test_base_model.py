...
class TestBaseModel(unittest.TestCase):
    ...
    def test_update(self):
        ''' testing that updated_at is updated auto with changes '''
    ...
    def test_to_dict_and_passing_dict_to_constructor(self):
        ''' testing to_dict method and passing a dict to the constructor '''
        test_dict = {'id': 'test_obj',
                'created_at': '2023-10-13T10:13:36.469639',
                'updated_at': '2023-10-13T10:13:36.469672',
                '__class__': 'BaseModel',
